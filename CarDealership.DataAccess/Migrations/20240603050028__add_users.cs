...
{
    /// <inheritdoc />
    public partial class _add_users : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstCardDigits = table.Column<string>(type: "text", nullable: true),
                    LastCardDigits = table.Column<string>(type: "text", nullable: true),
                    HasLinkedCard = table.Column<bool>(type: "boolean", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Deals_Users_CustomerId",
