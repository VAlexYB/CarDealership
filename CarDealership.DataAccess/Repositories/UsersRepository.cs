    ...
    public class UsersRepository : IUsersRepository
    {
        ...
        public async Task AddAsync(User user)
        {
            ...
            if (existingUser != null)
            {
                ...
                {
                    throw new ClientInformationException("В системе уже используется такая почта");
                }
                    
                if (existingUser.UserName == user.UserName)
                {
                    throw new ClientInformationException("В системе уже используется такой логин");
                }
            }
        ...
        public async Task<User> GetByEmailAsync(string email)
        {
            ...
            if (userEntity == null) throw new ClientInformationException("Не найден пользователь с таким Email");
        ...
        public async Task<User> GetByUsernameAsync(string username)
        {
            ...
            if (userEntity == null) throw new ClientInformationException("Не найден пользователь с таким Username");
